...
void solve(ll t)
{
    ll n;
    cin>>n;
    if(n%4==2||n%4==1){n();return;}
    if(n==3)
    {
    y();
    cout<<1<<nl;
    cout<<3<<nl<<2<<nl<<1<<" "<<2<<nl;
    return;
    }
    if(n%4==0)
    {y();
    ...
    cout<<(n+1)/2<<nl;
    cout<<1<<" "<<2<<" "<<4<<" "<<7<<" ";
    for(int i=8;i<=n;i+=4){cout<<i<<" ";}
    for(int i=11;i<=n;i+=4){cout<<i<<" ";}
    cout<<nl<<(n-1)/2<<nl;
    cout<<3<<" "<<5<<" "<<6<<" "; 
    for(int i=9;i<=n;i+=4){cout<<i<<" ";}
    for(int i=10;i<=n;i+=4){cout<<i<<" ";}
